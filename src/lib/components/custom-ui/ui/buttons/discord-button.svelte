...
<Button class="bg-[#5765f2] text-white hover:bg-[#4f5ce7]" href={href ? href : '/login/discord'}>
  <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 !size-5 fill-white" viewBox="0 0 256 199">
    <path
